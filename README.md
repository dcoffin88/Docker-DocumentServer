This build of onlyoffice community edition ( documentserver ) has connection limits increased to 9999.

All credits to [btactic](https://github.com/btactic-oo) and [thomisus](https://github.com/thomisus).
